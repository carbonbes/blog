<template>
  <ScrollArea scrollAreaClass="editor-scrollable-container">
    <EditorContent
      :editor
      class="editor [&_.tiptap]:pt-4 [&_.tiptap]:sm:pt-0 [&_.tiptap]:pb-[15vh] [&_.tiptap]:h-full [&_.tiptap]:min-[780px]:mx-8 [&_.tiptap_h1.is-empty]:before:content-[attr(data-placeholder)] [&_.tiptap_h1.is-empty]:before:h-0 [&_.tiptap_h1.is-empty]:before:text-gray-300 [&_.tiptap_h1.is-empty]:before:float-left [&_.tiptap_h1.is-empty]:before:pointer-events-none [&_.tiptap_h2.is-empty]:before:content-[attr(data-placeholder)] [&_.tiptap_h2.is-empty]:before:h-0 [&_.tiptap_h2.is-empty]:before:text-gray-300 [&_.tiptap_h2.is-empty]:before:float-left [&_.tiptap_h2.is-empty]:before:pointer-events-none [&_.tiptap_p.is-empty]:before:content-[attr(data-placeholder)] [&_.tiptap_p.is-empty]:before:h-0 [&_.tiptap_p.is-empty]:before:text-gray-300 [&_.tiptap_p.is-empty]:before:float-left [&_.tiptap_p.is-empty]:before:pointer-events-none [&_.tiptap_a]:text-blue-500 [&_.tiptap_a]:underline [&_.tiptap_[data-type=inline-spoiler]]:blur-sm [&_.tiptap_[data-type=inline-spoiler]]:transition-[filter] [&_.tiptap_[data-type=inline-spoiler]:hover]:blur-0 [&_.tiptap_>*]:px-4 [&_.tiptap_>*]:sm:px-0"
    />
  </ScrollArea>
